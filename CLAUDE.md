...
- Prototype phase COMPLETE and committed (66f61a2, 2026-07-13): user approved after two revision rounds (server renames, dual bridges, gremlin mode with purple imp badges and per-tier pacing). Now in the homepage build - see "Homepage build" and "TODO: Hero integration + scrollytelling" sections above for the active plan; large-tier density, dimmed-node treatment, and gremlin fixer ideas now live there, not here.
